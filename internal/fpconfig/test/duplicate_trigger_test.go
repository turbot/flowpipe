...
func TestDuplicateTriggers(t *testing.T) {
	...
	_, _, err := misc.LoadPipelines(context.TODO(), "./test_pipelines/invalid_pipelines/duplicate_triggers.fp")
...
func TestDuplicateTriggersDiffPipeline(t *testing.T) {
	...
	_, _, err := misc.LoadPipelines(context.TODO(), "./test_pipelines/invalid_pipelines/duplicate_triggers_diff_pipeline.fp")
