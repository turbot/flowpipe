...
func TestLoadPipelineDir(t *testing.T) {
	...
	pipelines, _, err := misc.LoadPipelines(context.TODO(), "./test_pipelines/pipelines/simple")
...
func SkipTestLoadPipelineDirRecursive(t *testing.T) {
	...
	pipelines, _, err := misc.LoadPipelines(context.TODO(), "./test_pipelines/pipelines/**/*.fp")
	assert.Nil(err, "error found")
...
func SkipTestLoadPipelineFromFileMatchesGlob(t *testing.T) {
	...
	pipelines, _, err := misc.LoadPipelines(context.TODO(), "./test_pipelines/pipelines/simple/simple*.fp")
	assert.Nil(err, "error found")
...
func TestSleepWithOutput(t *testing.T) {
	...
	pipelines, _, err := misc.LoadPipelines(context.TODO(), "./test_pipelines/pipelines/sleep_with_output/sleep_with_output.fp")
	assert.Nil(err, "error found")
...
func TestLoadPipelineDepends(t *testing.T) {
	...
	pipelines, _, err := misc.LoadPipelines(context.TODO(), "./test_pipelines/pipelines/depends/depends.fp")
	assert.Nil(err, "error found")
