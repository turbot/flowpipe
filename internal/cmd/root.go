...
func rootCommand(ctx context.Context) *cobra.Command {
	...
	cmdconfig.
		...
		AddStringFlag(constants.ArgConfigPath, localconstants.DefaultConfigPath, "Colon separated list of paths to search for workspace files, in order of decreasing precedence").
