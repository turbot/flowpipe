...
func TestHTTPMethodGET(t *testing.T) {
	...
	input := flowpipe2.Input(map[string]interface{}{
...
func XTestHTTPMethodGETWithJSONResponse(t *testing.T) {
	...
	input := flowpipe2.Input(map[string]interface{}{
		...
		schema.AttributeTypeMethod: flowpipe2.HttpMethodGet,
	})
...
func TestHTTPMethodPOST(t *testing.T) {
	...
	input := flowpipe2.Input(map[string]interface{}{
		...
		schema.AttributeTypeMethod: flowpipe2.HttpMethodPost,
		schema.AttributeTypeRequestBody: `{
			"userId": 1001,
			"it": 1001,
			"title": "Test 1001"
...
func TestHTTPMethodDELETE(t *testing.T) {
	...
	input := flowpipe2.Input(map[string]interface{}{
		...
		schema.AttributeTypeMethod: flowpipe2.HttpMethodDelete,
	})
...
func TestHTTPMethodPUT(t *testing.T) {
	...
	input := flowpipe2.Input(map[string]interface{}{
		schema.AttributeTypeUrl:    "https://jsonplaceholder.typicode.com/posts/1",
		schema.AttributeTypeMethod: flowpipe2.HttpMethodPut,
...
func TestHTTPMethodPATCH(t *testing.T) {
	...
	input := flowpipe2.Input(map[string]interface{}{
		schema.AttributeTypeUrl:    "https://jsonplaceholder.typicode.com/posts/1",
		schema.AttributeTypeMethod: flowpipe2.HttpMethodPatch,
		schema.AttributeTypeRequestHeaders: map[string]interface{}{
			"Content-Type": "application/json",
		},
		schema.AttributeTypeRequestBody: `{
