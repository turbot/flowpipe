...
func AddEachForEach(stepForEach *flowpipe.StepForEach, evalContext *hcl.EvalContext) *hcl.EvalContext {
...
// This function mutates evalContext
func AddLoop(stepLoop *flowpipe.StepLoop, evalContext *hcl.EvalContext) *hcl.EvalContext {
...
func AddStepPrimitiveOutputAsResults(stepName string, output *flowpipe.Output, evalContext *hcl.EvalContext) (*hcl.EvalContext, error) {
...
func AddStepCalculatedOutputAsResults(stepName string, stepOutput map[string]interface{}, stepInput *flowpipe.Input, evalContext *hcl.EvalContext) (*hcl.EvalContext, error) {
