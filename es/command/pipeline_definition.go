	...
	definitions := map[string]*pipeline.Pipeline{
		"my_pipeline_0": {
			...
			Steps: []pipeline.PipelineStep{
				...
				{Type: "exec", Name: "exec_1", DependsOn: []int{2}, Input: map[string]interface{}{"command": "ls"}},
				...
				{Type: "pipeline", Name: "pipeline_a", DependsOn: []int{2}, Input: map[string]interface{}{"name": "my_pipeline_1"}},
				{Type: "pipeline", Name: "pipeline_b", DependsOn: []int{3}, Input: map[string]interface{}{"name": "my_pipeline_1"}},
			},
		},
		"my_pipeline_1": {
			Type: "pipeline",
